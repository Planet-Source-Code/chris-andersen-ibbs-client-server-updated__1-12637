...
strAdminMessage = "admin1||" & InputBox("Enter Message:", "Admin Message")
'Send the message to all clients.
'Not implemented yet due to priority.
...
Select Case vntArray(0)
    ...
    Case "imcode1"
        ...
        For Each colitem In colUsers
            ...
            If colUsers(CStr(i)) = strIMTo Then
                ...
                txtClientOutput.Text = txtClientOutput.Text & vbCrLf & strIMSendtoClient
    ...
    Case "userlist1"
        ...
        i = 0
        'Build string of users to send to clients
        For Each colitem In colUsers
            i = i + 1
            strUsersNew = strUsersNew & colUsers.Item(i) & "||"
        Next colitem
    ...
    Case "mailcode1"
        'email string
        'This will be for users personel email
...
'With colUsers(CStr(lngSock))
    ...
    'Assign the string of data to the function so it an be sent
